...
val checkWinuiJvmApiClasspathBoundary by tasks.registering {
    ...
    doLast {
        ...
        val forbiddenEntries = listOf(
            ...
            "org/jetbrains/skiko/redrawer/AbstractDirectXRedrawer",
            ...
            "org/jetbrains/skiko/redrawer/DispatcherToBlockOn",
